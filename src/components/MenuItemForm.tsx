...
const MenuItemForm: React.FC<MenuItemFormProps> = ({
  ...
  return <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center py-8">
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              {customFields.length === 0 ? (
                <p className="text-sm text-gray-500 italic">
                  No hay campos de personalización. Haz clic en "Add Field" para agregar uno.
                </p>
              ) : (
                <div className="space-y-4">
                    ...
                    <div key={field.id} className="p-3 border border-gray-200 rounded-md bg-gray-50">
                      ...
                      <div className="space-y-2">
                        ...
                        <div>
                          ...
                          <select
                            value={field.type}
                            onChange={(e) => handleFieldTypeChange(field.id, e.target.value as CustomField['type'])}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-1.5 px-2 text-sm focus:outline-none focus:ring-custom-green-500 focus:border-custom-green-500"
                          >
                            <option value="dropdown">Lista Desplegable</option>
                            <option value="checkboxes">Opciones Casillas</option>
                            <option value="dropdown-quantity">Lista desplegable con cantidad</option>
                          </select>
                        </div>

                        {/* Options for dropdown and checkboxes */}
                        {(field.type === 'dropdown' || field.type === 'checkboxes' || field.type === 'dropdown-quantity') && (
                          <div>
