...
export default function Page() {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setResetError('Error al enviar el código. Verifica que el email sea correcto.')
    }
  }

  // Función para verificar código y establecer nueva contraseña
  const handleVerifyCodeAndSetPassword = async (e) => {
    e.preventDefault()
    ...
    try {
      ...
      setResetError('Código incorrecto o error al establecer contraseña. Inténtalo de nuevo.')
    }
  }
            ...
            {resetStatus === '' || resetStatus === 'sending' ? (
              <>
                ...
                <form onSubmit={handleResetPassword} className="space-y-4">
                  ...
                  {resetError && resetStatus !== 'code' && resetStatus !== 'resetting' && (
                  ...
                  >
                    {resetStatus === 'sending' ? 'Enviando...' : 'Enviar código'}
                  </button>
                </form>
              </>
              ...
              <>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Ingresa el código que enviamos a <strong>{resetEmail}</strong> y tu nueva contraseña
                </p>

                <form onSubmit={handleVerifyCodeAndSetPassword} className="space-y-4">
                  <div className="space-y-4">
                    <div className="relative">
                      ...
                      />
                      <label className="block text-xs text-gray-600 mt-1">Código de verificación</label>
                    </div>
                  ...
                  >
                    {resetStatus === 'resetting' ? 'Verificando...' : 'Establecer contraseña'}
                  </button>
                </form>
              </>
            ) : resetStatus === 'success' ? (
